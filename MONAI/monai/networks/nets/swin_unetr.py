...
class Mlp_LoRA(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.0):
        ...
        self.fc1 = lora.Linear(in_features, hidden_features, r=8)
        self.act = act_layer()
        self.fc2 = lora.Linear(hidden_features, out_features, r=8)
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = Mlp_LoRA(in_features=dim, hidden_features=mlp_hidden_dim, out_features=dim, act_layer=nn.GELU, drop=drop)
